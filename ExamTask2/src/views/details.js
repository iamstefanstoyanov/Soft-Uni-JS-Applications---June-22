...
let detailsTemplate = (book, isOwner, onDelete, likes, showLikeButton, onLike) =>
  html`
    <section id="details-page" class="details">
      <div class='book-information'>
        ...
        <div class='actions'>
            ${booksControlsTemplates(book, isOwner,onDelete)}
...
let booksControlsTemplates = (book, isOwner, onDelete) => {
  if (isOwner) {
    return html`
